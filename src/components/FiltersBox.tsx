...
interface FiltersBoxProps {
  setPrikazaniTelefoni: (telefoni: any[]) => void;  // Replace `any[]` with a more specific type if possible
}
...
export function FiltersBox({ setPrikazaniTelefoni }: FiltersBoxProps) {
  return (
    <div className="filterBox">
      ...
      <img src="/images/samsungLogo.webp" className="partneri polaSirina2" alt="Samsung" />
      <img src="/images/appleLogo.webp" className="partneri polaSirina1" alt="Apple" />
      <img src="/images/xiaomiLogo.webp" className="partneri polaSirina2" alt="Xiaomi" />
      <img src="/images/HonorLogo.webp" className="partneri polaSirina1" alt="Honor" />
      <img src="/images/motorolaLogo.png" className="partneri polaSirina2" alt="Motorola" />
